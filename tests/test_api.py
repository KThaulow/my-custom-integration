"""Tests for My Custom Integration api."""
import asyncio

import aiohttp
from custom_components.my_custom_integration.api import (
    MyCustomIntegrationApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = MyCustomIntegrationApiClient("test", "test", async_get_clientsession(hass))
